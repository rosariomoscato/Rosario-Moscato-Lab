...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 14 11:01:09 2020

@author: Rosario Moscato

Required Packages
NLP Pkgs: pip install spacy textblob 
Summarization Pkgs: pip install gensim
...
def main():
    ...
    st.sidebar.image("nlp.jpeg", use_column_width=True)#width=200)
    ...
    if choice == 'Text Analysis':
        ...
        raw_text = st.text_area("","Enter a Text in English...",height=250)
                    ...
                    with col4:
                        with st.beta_expander("Summarize"):
                            ...
                            if summary_text != "":
                                ...
                                st.warning("Please innsert a Longer Text")
